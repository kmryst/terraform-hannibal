...
| <a name="output_fis_experiment_template_id"></a> [fis\_experiment\_template\_id](#output\_fis\_experiment\_template\_id) | AWS FIS experiment template ID for the Game Day ECS task stop exercise (Issue #447) |
