...
variable "container_image_uri" {
  ...
  type        = string
  default     = "258632448142.dkr.ecr.ap-northeast-1.amazonaws.com/nestjs-hannibal-3@sha256:192aef2ce21c2a2cc5234a53abf6754fed26201dbc0e1446eebd557cc18f5ad0" # 最新ダイジェスト使用（確認済み）
}
...
variable "health_check_path" {
  ...
  type        = string
  default     = "/health/alb" # Professional設計: 最軽量ALB専用エンドポイント
