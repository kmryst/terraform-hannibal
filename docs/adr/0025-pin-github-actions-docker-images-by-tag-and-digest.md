...
| Docker smoke test health check | `curlimages/curl` | `curlimages/curl:8.21.0@sha256:7c12af72ceb38b7432ab85e1a265cff6ae58e06f95539d539b654f2cfa64bb13` | 既存は tag なし `latest` 相当をやめる。確認時点の `latest` が `curl 8.21.0` で、`8.21.0` tag と digest が一致したため同じ実体を固定する。 | `docker buildx imagetools inspect curlimages/curl:8.21.0` |
