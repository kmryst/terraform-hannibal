...
3. **結果記録**: [game-day-exercise-template.md](./game-day-exercise-template.md)をコピーし、`docs/operations/game-day-exercises/<日付>-<概要>.md`として復旧時間・アラーム発火有無をコミットする（Issueコメントのみでは正式な記録として扱わない。過去の記録は[game-day-exercises/](./game-day-exercises/)を参照）
